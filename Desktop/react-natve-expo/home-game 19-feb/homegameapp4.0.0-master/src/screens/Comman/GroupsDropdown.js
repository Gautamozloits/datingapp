...
export default class GroupsDropdown extends Component {
  ...
  toggleCreateGroup = () => {
    //this.props.that.showDropdown(this.props.user, this.props.userIndex)
    //this.props.that.toggleCreateGroup();
    //this.props.thatA.setState({isAddPlayerModalVisible: false})
    this._onModalPress()
  ...
  onItemPressed(item) {
    ...
    // } else {
    //   ToastMessage('Please enter phone number first', 'error')
    // }
