...
export default class ContainerListScreen extends React.Component {
    constructor(props) {
        super(props);
        this.password = '';
        this.state = {
    ...
    render() {
        return (
            <View style={{flex:1}} keyboardVerticalOffset = {0} behavior="padding" enabled>
            <SafeAreaView style={[Styles.safearea, {paddingBottom:0}]}>
                ...
                <View style={[Styles.container,{padding: 15, backgroundColor:COLOR.BG_COLOR},this.props.styles]}>
                    {this.props.children}
                </View>
