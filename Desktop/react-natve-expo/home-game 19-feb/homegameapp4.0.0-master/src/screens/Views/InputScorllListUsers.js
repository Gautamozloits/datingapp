...
export default class InputScorllListUsers extends React.Component {
    constructor(props) {
        super(props);
        this.password = '';
        this.state = {
    ...
    render() {
        return (
            <KeyboardAvoidingView style={{height:screenHeight-55}} keyboardVerticalOffset = {55} behavior="height">
