...
export default class ShareFinalSettlement extends React.Component {

  

  finalSettlementCard = (item) => {
    return (<View style={styles.row} key={item.id.toString() + Math.random()}>
  ...
  render() {
    ...
    return this.shareFinalSettlement();
